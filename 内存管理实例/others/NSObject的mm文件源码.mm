...
//  内存管理实例
//
//  Created by 汪俊 on 2018/4/24.
//  Copyright © 2018年 汪俊. All rights reserved.
//

#import "NSObject的mm文件源码.h"

@implementation NSObject_mm____
...
objc_storeWeak(id *location, id newObj) {
    return storeWeak<true, true, true>
...
objc_storeWeakOrNil(id *location, id newObj) {
    return storeWeak<true, true, false>
    (location, (objc_object *)newObj);
}
...
objc_initWeakOrNil(id *location, id newObj) {
    ...
    return storeWeak<false, true, false>
    (location, (objc_object*)newObj);
}
